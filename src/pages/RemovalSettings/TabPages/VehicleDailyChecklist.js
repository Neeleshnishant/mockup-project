...
export const VehicleDailyChecklist = () => {
  ...
  return (
    <div>
      <Card>
        <CardHeader>
          <h5 className="mb-0 text-primary">Checklist Group</h5>
        </CardHeader>
        <CardBody>
              ...
              <Col xl={12}>
                <div className="table-responsive mt-4 mt-xl-0">
                  ...
                  <Table className="table table-bordered table-nowrap align-middle mb-3">
                    ...
                    <tbody>
                      <tr>
                        <td className="fw-medium">Equipment</td>
                        <td>
                      ...
                      <tr>
                        <td className="fw-medium">Documents</td>
                        <td>
                          <div className="hstack gap-3 flex-wrap">
                            <Link to="#" className="link-success fs-15"><i className="ri-edit-2-line"></i></Link>
                            <Link to="#" className="link-danger fs-15"><i className="ri-delete-bin-line"></i></Link>
                      ...
                      <tr>
                        <td className="fw-medium">Mirrors</td>
                        <td>
                          <div className="hstack gap-3 flex-wrap">
                            <Link to="#" className="link-success fs-15"><i className="ri-edit-2-line"></i></Link>
                            <Link to="#" className="link-danger fs-15"><i className="ri-delete-bin-line"></i></Link>
                      ...
                      <tr>
                        <td className="fw-medium">Brakes</td>
                        <td>
                          <div className="hstack gap-3 flex-wrap">
                            <Link to="#" className="link-success fs-15"><i className="ri-edit-2-line"></i></Link>
                            <Link to="#" className="link-danger fs-15"><i className="ri-delete-bin-line"></i></Link>
      ...
      <Card className="mt-1">
        <CardHeader>
          <h5 className="mb-0 text-brown">CheckList</h5>
        </CardHeader>
        <CardBody>
          <Row>
            <Col lg={4}>
              <h6 className="mb-0 mt-3">Choose Group</h6>
            </Col>
            <Col lg={4}>
              <select className="form-select mb-3" aria-label="Default select example">
                <option >Select Group Checklist </option>
          ...
          <Button className="btn btn-brown mb-4"><i className="bx bx-check " /> Load Checklist</Button>
          <div className="live-preview">
            <Row>
              <Col xl={12}>
                <div className="table-responsive mt-4 mt-xl-0">
                  ...
                  <Table className="table table-bordered table-nowrap align-middle mb-3">
                    ...
                    <tbody>
                      <TableCheckList rowsData={rowsData} deleteTableRows={deleteTableRows} handleChange={handleChange} />
