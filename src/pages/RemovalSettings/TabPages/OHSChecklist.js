              ...
              <Col xl={12}>
                <div className="table-responsive mt-4 mt-xl-0">
                  ...
                  <Table className="table table-bordered table-nowrap align-middle mb-3">
                    ...
                    <tbody>
                      <tr>
                        <td className="fw-medium">Hazard / Risk</td>
                        <td>
                      ...
                      <tr>
                        <td className="fw-medium">Slip / Trip / Fall</td>
                      ...
                      <tr>
                        <td className="fw-medium">Traffic / Parking / Loading</td>
                      ...
                      <tr>
                        <td className="fw-medium">Power Lines / Eaves / Trees</td>
