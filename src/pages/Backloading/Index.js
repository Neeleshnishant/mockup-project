                                        ...
                                        <Col lg={2}>
                                            <div className="mb-3">
                                                ...
                                                <select className="form-select mb-3" aria-label="Default select example">
                                                    ...
                                                    <option defaultValue="2">Completed</option>
                                ...
                                <Form className="tablelist-form" onSubmit={(e) => {
                                            ...
                                            <Col lg={6}>
                                                <div className="mb-3">
                                                    ...
                                                    <select className="form-select mb-3" aria-label="Default select example">
                                                        ...
                                                        <option defaultValue="2">Blank2 Employee1</option>
                                                        <option defaultValue="3">Joe Davids</option>
                                                    </select>
                                                </div>
                                            </Col>
                                            <Col lg={12}>
                                    ...
                                    <ModalFooter>
                                        <div className="hstack gap-2 justify-content-end">
                                            ...
                                            <button type="submit" className="btn btn-success" id="add-btn" > {!!isEdit ? "Update Trip" : "Create Trip"} </button>
                                        </div>
                                    </ModalFooter>
                                </Form>
                            </Modal>
